<div xmlns:x-filament-tables="http://www.w3.org/1999/html">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 p-6 hover:shadow-md transition-shadow">
            ...
            @foreach($readings as $reading)
                <tr class="fi-ta-row transition-colors hover:bg-gray-50 dark:hover:bg-white/5 {{ $reading->volume === 'interpolated' ? 'bg-blue-50 dark:bg-blue-400/10' : '' }}">
                    <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3">
                        <div class="px-3 py-4">
                            <span class="text-sm text-gray-950 dark:text-white">{{ number_format($reading->dip_mm, 2) }}</span>
                        </div>
                    </td>
                    <td class="fi-ta-cell p-0">
                        <div class="px-3 py-4">
                            <span class="text-sm text-gray-950 dark:text-white">{{ number_format($reading->volume, 2) }}</span>
                        </div>
                    </td>
                    <td class="fi-ta-cell p-0">
                        <div class="px-3 py-4">
