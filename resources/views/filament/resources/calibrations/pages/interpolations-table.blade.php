<div xmlns:x-filament-tables="http://www.w3.org/1999/html">
    @php
        ...
        $interpolatedCount = $interpolations->count() - $manualCount;
    @endphp
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $interpolations->count() }}</p>
                    </div>
    ...
    <table class="fi-ta-table w-full table-auto divide-y divide-gray-200 dark:divide-white/5">
        ...
        <tr class="bg-gray-50 dark:bg-white/5">
            ...
            @if($hasWidget)
                <th class="fi-ta-header-cell px-3 py-3.5 text-start">
                    <span class="text-sm font-semibold text-gray-950 dark:text-white">Average</span>
                </th>

                <th class="fi-ta-header-cell px-3 py-3.5 text-start">
                    <span class="text-sm font-semibold text-gray-950 dark:text-white">Processed By</span>
                </th>
        ...
        @foreach($interpolations as $reading)
            <tr class="fi-ta-row transition-colors  dark:hover:bg-white/5 {{ $reading->reading ? 'bg-blue-100 dark:bg-blue-400/10' : '' }}">
                ...
                @if($hasWidget)
                    ...
                    <td class="fi-ta-cell p-0">
                        <div class="px-3 py-4">
                            <span class="text-sm text-gray-950 dark:text-white">{{ $reading->interpolation_average }}</span>
                        </div>
                    </td>

                    <td class="fi-ta-cell p-0">
                        <div class="px-3 py-4">
                            <span class="text-sm text-gray-950 dark:text-white">{{ $reading->runBy->name }}</span>
                        </div>
                    </td>
                @endif
            </tr>
